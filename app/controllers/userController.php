<?php
	...
	class userController extends mainModel{
		...
		public function registrarUsuarioControlador(){
		    ...
		    $apellido_pat=$this->limpiarCadena($_POST['apepat']);
			$apellido_mat=$this->limpiarCadena($_POST['apemat']);
		    ...
		    if($nombre=="" || $apellido_pat=="" ||$apellido_mat=="" || $usuario=="" || $clave1=="" || $clave2==""){
		    	$alerta=[
					"tipo"=>"simple",
		    ...
		    if($this->verificarDatos("[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,40}",$apellido_pat)){
		    	$alerta=[
					"tipo"=>"simple",
					"titulo"=>"Ocurrió un error inesperado",
			...
			if($this->verificarDatos("[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,40}",$apellido_mat)){
		    	$alerta=[
					"tipo"=>"simple",
					"titulo"=>"Ocurrió un error inesperado",
					"texto"=>"El APELLIDO no coincide con el formato solicitado",
		    ...
		    if($email!=""){
				if(filter_var($email, FILTER_VALIDATE_EMAIL)){
					$check_email=$this->ejecutarConsulta("SELECT MAIL FROM users WHERE MAIL='$email'");
            ...
            # Verificando usuario #
		    $check_usuario=$this->ejecutarConsulta("SELECT USER FROM users WHERE USER='$usuario'");
		    ...
		    $usuario_datos_reg=[
				...
				[
					...
					"campo_valor"=>$apellido_pat
				],
				[
					"campo_nombre"=>"APEMAT",
					"campo_marcador"=>":APEMAT",
					"campo_valor"=>$apellido_mat
				],
				[
					"campo_nombre"=>"USER",
					"campo_marcador"=>":USER",
				...
				[
					"campo_nombre"=>"LAST_INICIO",
					"campo_marcador"=>":LAST_INICIO",
					"campo_valor"=>date("Y-m-d H:i:s")
				]
			];
			...
			if($registrar_usuario->rowCount()==1){
				$alerta=[
					...
					"texto"=>"El usuario ".$nombre." ".$apellido_pat." se registro con exito",
					"icono"=>"success"
				];
			}else{
