    ...
    <link rel="shortcut icon" href="<?php echo APP_URL; ?>/app/views/images/favicon.svg">
    <!-- ************************ CSS Files ************************* -->
    <link rel="stylesheet" href="<?php echo APP_URL; ?>/app/views/fonts/remix/remixicon.css">
